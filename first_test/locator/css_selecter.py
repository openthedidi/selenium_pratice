...
# ------- tag & id ----------#
# input_tag_id = chrom_drive.find_element(By.CSS_SELECTOR, "input#small-searchterms")--推薦唯一值機會較大
# input_tag_id  = chrom_drive.find_element(By.CSS_SELECTOR, "#small-searchterms")


# ------- tag & class ----------#
# input_tag_class = chrom_drive.find_element(
...
# ------- tag & attribute ----------#
# input_tag_attribute = chrom_drive.find_element(
#     By.CSS_SELECTOR, "input[placeholder='Search store']")


# -------- tag & attribut & class -------#  唯一值機會最大
# input_tag_attribute_class = chrom_drive.find_element(
